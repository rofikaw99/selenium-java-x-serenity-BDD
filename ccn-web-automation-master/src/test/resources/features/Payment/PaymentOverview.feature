...
#      | User have company |
  ...
  @PPM_TC_49_1 @PaymentOverview @PaymentModule @login
...
#    Then verify field to be display on my payment
  ...
  @PPM_TC_49_2 @PaymentOverview @PaymentModule @login
...
#    Then verify field to be display on my payment
  ...
  @PPM_TC_49_3 @PaymentOverview @PaymentModule @login
...
#    Then verify field to be display on my payment
  ...
  @PPM_TC_53_1 @keywordFilter @PaymentOverview @PaymentModule @login
...
#    When input filter keyword "<keyword>"
  ...
  @PPM_TC_53_2 @keywordFilter @PaymentOverview @PaymentModule @login
  Scenario Outline: Authorized User verify field to be display on my payment
    Given "<condition>" login to the web
#    When User go to "<menu>"
#    Then verify field to be display on my payment
#    When input filter keyword "<keyword>"
  ...
  @PPM_TC_53_3 @keywordFilter @PaymentOverview @PaymentModule @login
  Scenario Outline: User verify field to be display on my payment
    Given "<condition>" login to the web
#    When User go to "<menu>"
#    Then verify field to be display on my payment
#    When input filter keyword "<keyword>"
  ...
  @PPM_TC_50_1_1 @PaymentOverview @PaymentModule @login
...
#    And verify button checkout unable to click
  ...
  @PPM_TC_50_1_2 @PaymentOverview @PaymentModule @login
...
#    And verify button checkout unable to click
  ...
  @PPM_TC_50_1_3 @PaymentOverview @PaymentModule @login
...
#    And verify button checkout unable to click
  ...
  @PPM_TC_50_2_1 @PaymentOverview @PaymentModule @login
...
#    And verify button checkout enable to click
  ...
  @PPM_TC_50_2_2 @PaymentOverview @PaymentModule @login
...
#    And verify button checkout enable to click
  ...
  @PPM_TC_50_2_3 @PaymentOverview @PaymentModule @login
  Scenario Outline: User verify outstanding payment request status
    Given "<condition>" login to the web
#    When User go to "<menu>"
#    Then verify field to be display on my payment
...
#    And verify button checkout enable to click
  ...
  @PPM_TC_50_3_1 @PaymentOverview @PaymentModule @login
...
#    Then verify paid status color code is correct
  ...
  @PPM_TC_50_3_2 @PaymentOverview @PaymentModule @login
...
#    Then verify paid status color code is correct
  ...
  @PPM_TC_50_3_3 @PaymentOverview @PaymentModule @login
...
#    Then verify paid status color code is correct
  ...
  @PPM_TC_50_4_1 @PaymentOverview @PaymentModule @login
...
#    Then verify expired status color code is correct
  ...
  @PPM_TC_50_4_2 @PaymentOverview @PaymentModule @login
...
#    Then verify expired status color code is correct
  ...
  @PPM_TC_50_4_3 @PaymentOverview @PaymentModule @login
...
#    Then verify expired status color code is correct
  ...
  @PPM_TC_51_1 @PaymentOverview @PaymentModule @login
...
#    And verify payment detail information
  ...
  @PPM_TC_51_2 @PaymentOverview @PaymentModule @login
...
#    And verify payment detail information
  ...
  @PPM_TC_51_3 @PaymentOverview @PaymentModule @login
...
#    And user click pay after checkout
  ...
  @PPM_TC_28 @PaymentOverview @PaymentModule @login
...
#    And user click pay after checkout
  ...
  @PPM_TC_30 @PaymentOverview @PaymentModule @login
...
#    And user click pay for CC after checkout
  ...
  @PPM_TC_34 @PaymentOverview @PaymentModule @login
...
#    And user click pay for CC after checkout
  ...
  @PPM_TC_35 @PaymentOverview @PaymentModule @login
...
#    Then user click pay for CC after checkout
  ...
  @PPM_TC_36 @PaymentOverview @PaymentModule @login
...
#    And user click pay after checkout
  ...
  @PPM_TC_31 @PaymentOverview @PaymentModule @login
